  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  cfg_.left_wheel_names = hardware_interface::parse_string_vector(
    info_.hardware_parameters.at("left_wheel_names"));
  cfg_.right_wheel_names = hardware_interface::parse_string_vector(
  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  comms_connect(cfg_.device, cfg_.baud_rate, cfg_.timeout_ms);
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  int motor_lr_counts_per_loop = wheel_lr_.cmd / wheel_lr_.rads_per_count / cfg_.loop_rate; 
