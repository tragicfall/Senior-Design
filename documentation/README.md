...
This folder contains key engineering documents for the Roambot project. These documents provide detailed specifications, requirements, and design information, which are essential for understanding the system's architecture and development process.

Documents Included:

1. **PC** (Project Charter): Defines the scope, objectives, and overall plan for the Roambot project.
