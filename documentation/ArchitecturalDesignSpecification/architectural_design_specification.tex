...
\begin{versionhistory}
  	...
  	\vhEntry{1.0}{11.25.2024}{CD|RS|MG|AK|AH}{official release}
        \vhEntry{1.1}{04.30.2025}{MG|AK}{updated pathfinding subsystems}
        \vhEntry{2.0}{04.30.2025}{CD|RS|MG|AK|AH}{official release}
\end{versionhistory}
\newpage
...
\input{tex/1_movement_subsystems.tex}
\newpage
\section{Pathfinding Subsystems}
\input{tex/2_pathfinding_subsystems.tex}
\newpage
\section{Interface Subsystems}
\input{tex/3_interface_subsystems.tex}
\newpage
